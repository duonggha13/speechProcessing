...
def get_start_and_trans_matrix(name):
    state_map = {}
    state_map['benhnhan'] = 18
    state_map['vietnam'] = 18
    state_map['cach'] = 9
    state_map['nguoi'] = 9
    state_map['phai'] = 9
    state_map['test_benhnhan'] = 18
    state_map['test_vietnam'] = 18
    state_map['test_cach'] = 9
    state_map['test_nguoi'] = 9
    state_map['test_phai'] = 9
...
if __name__ == "__main__":
    ...
    for cname in class_names:
        ...
        hmm = hmmlearn.hmm.MultinomialHMM(
            n_components=state_map[cname], random_state=0, n_iter=1000, verbose=True,
